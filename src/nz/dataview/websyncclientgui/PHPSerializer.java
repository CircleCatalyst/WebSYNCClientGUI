...
class UnSerializeResult {
    ...
    protected int hv; 
    protected UnSerializeResult() {}

    protected UnSerializeResult(Object value, int hv) {
        this.value = value;
        this.hv = hv;
    }
}
...
public class PHPSerializer {
    ...
    private static int writeHashMap(ByteArrayOutputStream stream, HashMap h, HashMap ht, int hv, String charset) {
        ...
        for (Iterator keys = h.keySet().iterator(); keys.hasNext();) {
            ...
            if ((key instanceof Byte) || (key instanceof Short)
                ...
                writeInteger(stream, new byte[] { ((Boolean) key) ? __1 : __0 });
            } else {
    ...
    private static int writeObject(ByteArrayOutputStream stream, Object obj, HashMap ht, int hv, String charset) {
        ...
        if (obj instanceof java.io.Serializable) {
            ...
            if (obj instanceof nz.dataview.websyncclientgui.Serializable) {
                byte[] cs = ((nz.dataview.websyncclientgui.Serializable) obj).serialize();
    ...
    public static Object newInstance(Class cls) throws UnSerializeException {
        try {
        ...
        try {
            Constructor ctor = cls.getConstructor(Boolean.TYPE);
            int mod = ctor.getModifiers();
        ...
        throw new UnSerializeException(
                "Can't create the instance of " + cls.getName());
    }
    ...
    public static Object unserialize(byte[] ss) throws UnSerializeException {
        return unserialize(ss, null, "UTF-8");
    }

    public static Object unserialize(byte[] ss, String charset) throws UnSerializeException {
        return unserialize(ss, null, charset);
    }

    public static Object unserialize(byte[] ss, Class cls) throws UnSerializeException {
        return unserialize(ss, cls, "UTF-8");
    }

    public static Object unserialize(byte[] ss, Class cls, String charset) throws UnSerializeException {
        int hv = 1;
    ...
    private static UnSerializeResult unserialize(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset) throws UnSerializeException {
        Object obj;
        ...
        default:
            throw new UnSerializeException("Wrong Serialize Stream!");
        }
    }
    ...
    private static Object readInteger(ByteArrayInputStream stream) {
        stream.skip(1);
    ...
    private static Object readDouble(ByteArrayInputStream stream) {
        stream.skip(1);
    ...
    private static String readString(ByteArrayInputStream stream, String charset) {
        stream.skip(1);
        int len = new Integer(readNumber(stream));
    ...
    private static String readUnicodeString(ByteArrayInputStream stream) {
        stream.skip(1);
        int l = new Integer(readNumber(stream));
    ...
    private static UnSerializeResult readRef(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt) {
        stream.skip(1);
        int r = new Integer(readNumber(stream));
    ...
    private static UnSerializeResult readArray(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset) throws UnSerializeException {
        stream.skip(1);
        int n = new Integer(readNumber(stream));
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (stream.read()) {
            case __i:
                key = new Integer(readInteger(stream).toString());
                break;
    ...
    private static UnSerializeResult readObject(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset) throws UnSerializeException {
        stream.skip(1);
        int len = new Integer(readNumber(stream));
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (o instanceof HashMap) {
                ...
                try {
                    ...
                    throw new UnSerializeException(key + ":" + e.toString());
                }
            }
        }
        stream.skip(1);
        ...
        try {
            __wakeup = o.getClass().getMethod("__wakeup");
            __wakeup.invoke(o);
        } catch (Exception e) {}
        return new UnSerializeResult(o, hv);
    }

    private static UnSerializeResult readCustomObject(ByteArrayInputStream stream, HashMap ht, int hv, String charset) throws UnSerializeException {
        stream.skip(1);
        int len = new Integer(readNumber(stream));
        ...
        if (cls != null) {
            try {
                ...
                throw new UnSerializeException("Type " + cn + " is undefined!");
            }
        } else {
            throw new UnSerializeException("Type " + cn + " is undefined!");
        }
        ht.put(hv++, o);
        if (o instanceof nz.dataview.websyncclientgui.Serializable) {
            byte[] b = new byte[n];

            stream.read(b, 0, n);
            ((nz.dataview.websyncclientgui.Serializable) o).unserialize(b);
        } else {
            stream.skip(n);
        }
        stream.skip(1);
